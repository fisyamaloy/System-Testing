...
namespace Проект.Рестарт
{
    public class DB
    {
        ...
        public List<string> GetDataList(string require)
        {
        ...
        public string GetValue(string require)
        {
            string word = "";
            DB db = new DB();
            db.OpenConnection();
        ...
        public void AddToBD(string require, params string[] ToCorrespondinColumn)
        {
            DB db = new DB();
            db.OpenConnection();
            MySqlCommand command = new MySqlCommand(require, db.GetConnection());
        ...
        {
            return GetDataList("SELECT userclass FROM students").Distinct().ToList();
        }

        public void DeleteFromBD(string require)
        {
            DB db = new DB();
            db.OpenConnection();
            MySqlCommand command = new MySqlCommand(require, db.GetConnection());
        ...
        public void SetValue(string require)
        {
            DB db = new DB();
            db.OpenConnection();
            MySqlCommand command = new MySqlCommand(require, db.GetConnection());
